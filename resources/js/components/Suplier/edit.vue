         ...
         <div class="register-box" style="margin-left:19%">
            ...
            <div class="card card-primary" style="width:594px">
              <div class="card-header">
                <h3 class="card-title">Edite Suplier</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form @submit.prevent="UpdateSuplier" role="form">
                <div class="card-body">
                 <div class="row">
                  <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" @change="ImagePreviewUpdate" class="custom-file-input" id="exampleInputFile">
                 ...
                 <div class="form-group">
                    ...
                    <img :src="form.updateImage" style="height:100px;width:100px">
                  </div>
...
export default {
   ...
   methods: {
    UpdateSuplier(){
        ...
        axios.post('/api/supliar-update/'+EditeID,this.form)
        .then(()=>{
    ...
    created() {
        let Editeid = this.$route.params.id;
        axios.get('/api/supliar-edit/'+Editeid)
        .then(supliar=>this.form=supliar.data)
        .catch()
