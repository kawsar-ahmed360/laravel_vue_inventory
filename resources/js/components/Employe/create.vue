<template>
    <div>
            ...
            <div class="card card-primary" style="width:594px">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form @submit.prevent="EmployeInsert" role="form">
                <div class="card-body">
                 <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" @change="onFileSelected" class="custom-file-input" id="exampleInputFile">
...
created() {
 ...
 methods: {
    EmployeInsert(){
       ...
       axios.post('/api/employe-store',this.form)
       .then(()=>{
